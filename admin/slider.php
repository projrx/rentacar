...
<head>
 ...
 for ($i=0; $i < 100 ; $i++) { 
  ...
  $data=mysqli_query($con,"INSERT INTO slider (name,img,ordr,datec)VALUES ('$name','$image','$ordr','$datec')")or die( mysqli_error($con) );
  ...
  <?php include "include/sidebar.php"?>
      ...
      <div class="content-body">
        ...
        <div class="card-body">
          ...
          <h3> Homepage Main Slider Images: </h3>
          <br><br>
      ...
      while($row=mysqli_fetch_array($rows)){
        ...
        <form method="post" action="" enctype="multipart/form-data">
          ...
          <tr>
            ...
            <td>
              <img style="width:200px;height: 100px; " src="../images/slider/<?php echo $img ?>" class="form-control" ?><br>
