...
<head>
  ...
  if(isset($_POST['oid'])){
    ...
    header("location:torders.php"); // Redirecting To Other Page
}
...
?>
  ...
  <?php 
    ...
    if(isset($_GET['ter'])){
      ...
      $data=mysqli_query($con,"UPDATE orders SET `total`='$paid' where `id`='$id'")or die( mysqli_error($con) );
  ...
  <div class="content-wrapper">
    ...
    <tr>
     ...
     <div class="card">
        ...
        $rows =mysqli_query($con,"SELECT * FROM orders where status='terminated' LIMIT 1000" ) or die(mysqli_error($con));
        $n=0;
        $stotal=0;
...
-->
                ...
                <td> 
                  ...
                  <a class="btn btn-warning" href="?ter=<?php echo $oid ?>">Discount</a>
            ...
            <span>*Pressing Discount Button will Balance the Order Total Price Equal to Paid Payment.
